...
# ╔═╡ a19a3cc9-e6fd-4e13-aabc-9e78c5450288
begin
	using DataFrames
	using CSV
end

# ╔═╡ bb45d2b8-f268-401b-9bde-4d51ca8c3ede
using Plots  # This will install plots

# ╔═╡ 4cd2c05e-ed8d-484e-8cc1-5658f21fdd97
using PlutoUI

# ╔═╡ d7d373fc-01ad-4775-8fda-bc5a351fdc3a
df = CSV.read("WHO-COVID-19-global-data.csv", DataFrame)

# ╔═╡ 59288488-a5f5-43d0-9a5f-701654f07bf1
df.Country_code === df[!, "Country_code"]

# ╔═╡ 39796306-7ec0-4d03-8877-9c44110216cc
equals_sg(x::AbstractString) = x == "SG"

# ╔═╡ ffb3f7ab-2455-4d37-a482-1bb2755535f2
sg_data = filter(:Country_code => equals_sg, df)

# ╔═╡ 8d536363-e1ba-4d87-a79c-23940ebadf76
dates = sg_data[!, "Date_reported"]

# ╔═╡ 5403e91b-5bc5-4e7e-a9b6-55ddb120694b
cumulative_cases = sg_data[!, "Cumulative_cases"]

# ╔═╡ bf8b975c-391d-4e54-8395-841ba39ea86d
cumulative_data_plotted_over_date = plot(dates, cumulative_cases)

# ╔═╡ 702ba368-bd98-4db7-b934-1912c76363af
...
# ╔═╡ c18e6fbe-c39d-41e5-a368-032840f94099
@bind slider_value Slider(0:10:1000)

# ╔═╡ afa47d2a-e4a6-4c6f-9fe0-4bf1f01b14ae
md"""
### Slider Value Now At $(slider_value)
"""

# ╔═╡ 60f0572d-433c-4c86-ba3e-4ab1d42e1de7
@bind date_slider_index Slider(1:length(dates))

# ╔═╡ 3ad8a4e7-8eb2-437f-b3ba-5b7d94068898
md"""
### The date is now $(dates[date_slider_index])
"""

# ╔═╡ db42e37c-7d08-4b79-99a2-49ef7d9c9e51
