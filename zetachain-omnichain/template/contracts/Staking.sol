...
contract Staking is ERC20, zContract {
    ...
    constructor(string memory name_, string memory symbol_, uint256 chainID_, address systemContractAddress)
        ERC20(name_, symbol_)
    {
        ...
        onlySystem
    {
        ...
        uint8 action = chainID == BITCOIN ? uint8(message[0]) : abi.decode(message, (uint8));
    ...
    function setWithdraw(address staker, bytes calldata message, bytes memory origin) internal {
